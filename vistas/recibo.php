...
<body>
    ...
    <form id="aguaForm" action="../reporte/report.php" method="post" autocomplete="off">
        <div class="row">
            <div class="col-md-6 border-end">
                ...
                <!--N° MEDIDOR-->
                <div class="mb-3"> <label class="form-label">N° MEDIDOR</label> <select name="medidor" id="medidor_usuario"
                        class="form-select">
                        <option value=""><?php echo $datos['medidor']; ?></option>
                        </option>
                    </select> </div>


                <!--poligono-->
                <select name="lote_poligono" id="poligono_usuario" class="form-select">
                    <option value="<?= $datos['lote_poligono']; ?>">
                        <?= $datos['lote_poligono']; ?>
                    </option>
                </select>
                ...
                <div class="row">
                    ...
                    <div class="col-6 mb-3"> <label class="form-label">FECHA LECTURA</label> <input type="date" name="fecha_lectura" class="form-control" required> </div>
                </div>
            </div>
            <div class="col-md-6">
                <h5 class="mb-3 text-secondary">Lecturas y Consumo</h5>
                <div class="row">
                    <div class="col-6 mb-3"> <label class="form-label">Lectura Anterior</label> <input name="lec_anterior"
                            id="lec_anterior" type="number" class="form-control" step="any" oninput="calcular()" pattern="{1,100}" required> </div>
                    <div class="col-6 mb-3"> <label class="form-label">Lectura Actual</label> <input name="lec_actual"
                            id="lec_actual" type="number" class="form-control" step="any" oninput="calcular()" pattern="{1,100}" required> </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-6 mb-3"> <label class="form-label">Valor Consumo ($)</label> <input name="valor_consumo" id="total_valor" type="text" class="form-control result-field" readonly> </div>
                </div>
                <hr>
                <div class="row mt-3">
                    <div class="col-md-4 mb-3"> <label class="form-label">Mantenimiento</label> <input name="mantenimiento"
                            id="mantenimiento" value="30.00" type="number" value="0" oninput="calcular()" class="form-control"> </div>
                    <div class="col-md-4 mb-3"> <label class="form-label">Saldo Pendiente</label> <input name="saldo_pendiente"
                            id="saldo_pendiente" type="number" class="form-control" value="0" oninput="calcular()" placeholder="0.00"> </div>
                    <div class="col-md-4 mb-3"> <label class="form-label">Mora ($3.50)</label> <input name="mora" id="recargo" type="number" class="form-control" oninput="calcular()" value="0" placeholder="0.00"> </div>
                </div>
                <div class="bg-primary bg-opacity-10 p-4 rounded border border-primary border-2 shadow-sm">
                    <div class="d-flex justify-content-between align-items-center"> <label class="h5 text-primary mb-0 fw-bold">TOTAL A PAGAR:</label>
                        <div class="input-group w-50"> <span class="input-group-text bg-primary text-white border-0">$</span> <input id="gran_total" name="total" type="text" class="form-control form-control-lg text-end fw-bold border-0 bg-white" value="0.00" readonly> </div>
                    </div>
                </div>
            </div>
        </div>
